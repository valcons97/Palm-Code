...
extension StringX on String {
  ...
  String toIDRFormat([String fallback = '0']) {
    ...
    final body = substring(0, length).formatNumber('.');
  ...
  String toPoint([String fallback = '0']) {
    return '${toPointFormat(fallback)} Points';
  }

  String toPointFormat([String fallback = '0']) {
    // String is malformed
  ...
  /// Return string that should be used
  /// together with [TextOverflow.ellipsis]
  /// so overflowed word not being omitted entirely.
  ///
  /// e.g:
  /// Text(
  ///   'Some Wordddddddddddddddd'.ellipsizedString,
  ///   overflow: TextOverflow.ellipsis,
  /// )
  ///
  /// will displayed as something like 'Some Wordddd...'
  String get ellipsizedString {
    return characters
